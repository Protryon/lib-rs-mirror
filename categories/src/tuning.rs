...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "eth", "eth2", "cryptocurrency", "vapory", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
        ...
        (Cond::Any(&["service", "daemon", "server"]), &[("algorithms", 0.8, 0.), ("data-structures", 0.8, 0.)]),
