...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["kubernetes", "containerized", "k8s", "devops", "hypervisor"]),
            &[("development-tools", 1.2, 0.1), ("web-programming", 1.1, 0.02), ("web-programming::http-client", 0.9, 0.), ("os::macos-apis", 0.9, 0.), ("config", 0.9, 0.), ("os::windows-apis", 0.1, 0.), ("command-line-utilities", 1.1, 0.02)]),
        ...
        (Cond::Any(&["emscripten"]), &[("wasm", 1.1, 0.2), ("embedded", 0.3, 0.), ("multimedia::encoding", 0.4, 0.)]),
        ...
        (Cond::Any(&["compile-time", "codegen", "asm"]),
                &[("development-tools", 1.2, 0.2), ("rust-patterns", 1.1, 0.), ("game-engines", 0.5, 0.), ("multimedia::audio", 0.8, 0.), ("concurrency", 0.9, 0.), ("games", 0.15, 0.)]),
        ...
        (Cond::Any(&["tokenizer", "sanitizer", "parse", "lexer", "parser", "parsing"]),
            ...
            ("os::macos-apis", 0.9, 0.), ("command-line-utilities", 0.8, 0.), ("simulation", 0.8, 0.), ("encoding", 0.8, 0.),
        ...
        (Cond::Any(&["physics", "ncollide", "pressure"]),
            &[("science", 1.2, 0.1), ("simulation", 1.2, 0.1), ("multimedia::video", 0.8, 0.), ("game-engines", 1.1, 0.), ("science::math", 0.8, 0.), ("parsing", 0.8, 0.), ("parser-implementations", 0.8, 0.), ("science::ml", 0.7, 0.), ]),
        (Cond::Any(&["collision"]),
        ...
        (Cond::All(&["smart", "contract"]), &[("cryptography::cryptocurrencies", 1.3, 0.1), ("wasm", 0.5, 0.)]),
        ...
        (Cond::Any(&["fibonacci", "interpolate", "interpolation", "permutation", "dfa", "cellular-automata", "automata", "solvers", "solver", "integral"]),
        ...
        (Cond::All(&["pid", "control"]), &[("embedded", 1.2, 0.1), ("hardware-support", 1.2, 0.1)]),
        ...
        (Cond::Any(&["gpgpu", "cudnn"]), &[("asynchronous", 0.2, 0.), ("concurrency", 0.8, 0.), ("game-engines", 0.8, 0.), ("parsing", 0.5, 0.), ("filesystem", 0.7, 0.),
