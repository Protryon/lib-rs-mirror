...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["computer-vision"]),
            &[("science::ml", 1.2, 0.1), ("multimedia::images", 1.2, 0.), ("science", 1.1, 0.), ("no-std", 0.8, 0.), ("algorithms", 1.1, 0.)]),
        ...
        (Cond::Any(&["cryptocurrency", "dep:blockchain", "altcoin", "dep:web3", "dep:near-primitives", "dep:cw-utils", "dep:bitcoin", "dep:holochain_core_types", "dep:grin_api", "dep:grin_core", "bitcoincash", "cryptocurrencies", "blockchain", "blockchains", "exonum", "solana", "libra"]),
        ...
        (Cond::Any(&["accessibility"]), &[("gui", 1.2, 0.), ("web-programming", 1.1, 0.), ("internationalization", 1.1, 0.)]),
        ...
        (Cond::Any(&["rocket-league", "nintendo", "conway", "pokemon", "starcraft", "quake2", "quake3", "deathmatch", "roguelike", "roguelikes", "minecraft", "roblox", "sudoku"]),
