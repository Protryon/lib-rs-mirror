...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::All(&["proc", "macro"]), &[("rust-patterns", 1.1, 0.), ("development-tools::procedural-macro-helpers", 1.2, 0.), ("rendering::graphics-api", 0.8, 0.),]),
        ...
        (Cond::Any(&["markdown", "common-mark", "unicode-aware", "pulldown-cmark", "bbcode", "braille", "ascii", "ngrams"]),
            &[("text-processing", 1.2, 0.2), ("parser-implementations", 1.2, 0.), ("multimedia::video", 0.8, 0.), ("parsing", 0.9, 0.), ("development-tools::testing", 0.2, 0.), ("filesystem", 0.7, 0.), ("development-tools", 0.7, 0.), ("multimedia::images", 0.5, 0.), ("command-line-utilities", 0.5, 0.)]),
        ...
        (Cond::NotAny(&["web", "html", "js", "javascript", "json", "jwt", "github", "proxy", "apache", "rpc", "rest", "k8s", "containers", "kubernetes", "thrift", "serverless",
            "graphql", "lambda", "aws", "mime", "wordpress", "rss", "atom", "xml", "css", "xss", "rocket", "webhook", "conduit", "hyper", "nodejs", "asmjs", "browser",
            "front-end", "ipfs", "youtube", "google", "jsonrpc", "dep:cookie", "jsonapi", "http-api", "rest-api", "json-api", "webhook", "dep:rocket", "dep:actix-web", "website", "ct-logs"]),
        ...
        (Cond::NotAny(&["web", "http", "http2", "server", "router", "hyper", "actix", "apache", "conduit", "webserver", "serverless", "graphql", "aws", "lambda", "rpc", "iron",
