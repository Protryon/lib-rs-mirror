...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["web", "html", "js", "javascript", "json", "jwt", "proxy", "rest", "serverless", "graphql", "lambda", "aws", "mime", "wordpress", "rss", "atom", "xml", "css", "xss", "rocket", "webhook", "hyper", "nodejs", "asmjs", "browser", "front-end", "ipfs", "youtube", "google", "jsonrpc"]),
            &[("web-programming", 0.8, 0.)]),
        (Cond::NotAny(&["web", "http", "http2", "api", "fetch", "http-client", "serverless", "graphql", "lambda", "s3", "aws", "client", "rest", "gotham", "hyper", "request", "json", "jsonrpc", "rpc", "curl", "tls", "requests"]),
            &[("web-programming::http-client", 0.8, 0.)]),
        (Cond::NotAny(&["web", "http", "http2", "server", "router", "hyper", "actix", "webserver", "serverless", "graphql", "aws", "lambda", "rpc", "iron", "tcp", "sse", "server-sent-events", "service", "middleware", "microservice", "proxy", "rest", "restful", "framework", "rocket", "actix"]),
