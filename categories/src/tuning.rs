...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "snarkvm", "snarkos", "zcash", "tetcore", "ethcore", "xynthe", "mimblewimble", "crypto", "contract", "contracts", "smart-contracts", "cosmos", "eth", "stake", "near",
            "zk-snark", "dep:near-sdk", "dep:tet-core", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:ethereum-types", "parity", "solidity",
        ...
        (Cond::Any(&["ethereum", "ethcore", "snarkvm", "snarkos", "zcash", "bitcoin", "dep:tet-core", "tetcore", "xynthe", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
            "dep:holochain_core_types", "dep:ethereumvm", "dep:near-sdk", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
