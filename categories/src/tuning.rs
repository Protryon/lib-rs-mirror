...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["tokio", "future", "futures", "promise", "promises", "executor", "reactor", "eventloop", "event-loop", "event", "callback",
            "callbacks", "non-blocking", "async", "async-await", "await", "asynchronous", "aio", "mio", "timer"]),
            &[("asynchronous", 0.8, 0.)]),
        ...
        (Cond::Any(&["dep:quote"]), &[("development-tools::procedural-macro-helpers", 1.2, 0.1)]),
        ...
        (Cond::Any(&["dep:syn"]), &[("development-tools::procedural-macro-helpers", 1.2, 0.1)]),
        ...
        (Cond::NotAny(&["web", "html", "js", "javascript", "json", "jwt", "github", "proxy", "apache", "rpc", "rest", "k8s", "containers", "kubernetes", "thrift", "serverless",
            ...
            "front-end", "ipfs", "youtube", "google", "jsonrpc", "jsonapi", "http-api", "rest-api", "json-api", "webhook", "dep:actix-web", "website", "ct-logs"]),
