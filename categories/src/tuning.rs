...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "ethcore", "mimblewimble", "crypto", "contract", "contracts", "smart-contracts", "cosmos", "eth", "stake", "near", "zk-snark", "dep:near-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:ethereum-types", "parity", "solidity", "dep:solid", "holochain", "bitcoin", "solana", "monero", "coinbase",
        ...
        (Cond::Any(&["ethereum", "ethcore", "bitcoin", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble", "dep:ethereumvm", "dep:near-sdk", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
            &[("cryptography::cryptocurrencies", 1.7, 0.8), ("science::math", 0.8, 0.), ("parsing", 0.6, 0.), ("data-structures", 0.7, 0.), ("cryptography", 0.7, 0.), ("database-implementations", 0.7, 0.),
        ...
        (Cond::All(&["cosmwasm"]), &[("cryptography::cryptocurrencies", 1.2, 0.2)]),
