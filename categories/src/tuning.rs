...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["bioinformatics", "genomic", "bio", "benzene", "chemical", "biological", "rna", "genotype", "genbank"]),
        ...
        (Cond::NotAny(&["ethereum", "erc20", "substrate", "eth", "xrp", "xrpl", "corelightning", "aptos", "soroban", "fuel-vm", "sui", "algonaut", "eth2", "token", "dep:frame-support", "dep:gemachain-sdk", "dep:web3", "cryptocurrency", "vapory","arweave", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "marine", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
        ...
        (Cond::Any(&["ethereum", "erc20", "rapid-blockchain-prototypes", "ethcore", "corelightning", "owasm", "aptos", "fuel-vm", "xrpl", "algonaut", "tendermint", "randomx", "dep:wedpr_l_macros", "dep:solana-program", "tari", "safecoin",  "chainlink", "vapory", "arweave","nft", "web3", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
            "zcash", "bitcoin", "dep:tet-core", "tetcore", "kraken", "tezos", "solana", "xynthe", "dep:anchor-lang", "soroban", "dep:miniscript", "dep:ethereumvm", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
