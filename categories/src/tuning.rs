...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "ethcore", "mimblewimble", "crypto", "contract", "contracts", "eth", "stake", "near", "dep:near-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:ethereum-types", "parity", "solidity", "dep:solid", "bitcoin", "solana", "monero", "coinbase",
        ...
        (Cond::Any(&["ethereum", "ethcore", "bitcoin", "solidity", "dep:solid", "mimblewimble", "dep:ethereumvm", "dep:near-sdk", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
        ...
        (Cond::Any(&["cryptocurrency", "dep:blockchain", "altcoin", "dep:bitcoin", "dep:grin_api", "dep:grin_core", "bitcoincash", "cryptocurrencies", "blockchain", "blockchains", "exonum", "solana", "libra"]),
