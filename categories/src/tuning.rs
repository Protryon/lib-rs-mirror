...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::All(&["memory", "cache"]), &[("caching", 1.2, 0.1), ("memory-management", 1.1, 0.)]),
        ...
        (Cond::All(&["bash", "tool"]), &[("command-line-utilities", 1.2, 0.2)]),
        ...
        (Cond::Any(&["web", "webhook", "blog", "webdriver", "web-scraping", "browsers", "browser", "cloud", "reqwest", "webhooks", "elasticsearch", "web-api"]),
            &[("web-programming", 1.2, 0.1), ("embedded", 0.9, 0.), ("development-tools::cargo-plugins", 0.5, 0.), ("emulators", 0.4, 0.)]),
