...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "substrate", "eth", "xrp", "xrpl", "corelightning", "aptos", "fuel-vm", "eth2", "dep:frame-support", "dep:gemachain-sdk", "dep:web3", "cryptocurrency", "vapory","arweave", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
            "dep:ckb-types", "ethcore", "xynthe", "mimblewimble", "crypto", "contract", "safecoin", "contracts", "smart-contracts", "smart-contract", "cosmos", "eth", "stake", "near",
            ...
            "litecoin", "bitfinex", "ledger", "hyperledger", "btc", "sway", "fuel", "interledger", "dep:anchor-lang", "agsol", "apdu", "abci", "dep:wedpr_l_macros", "consensus", "contract", "dep:parity-scale-codec", "self-sovereign", "dep:libp2p", "dep:bitcoin", "dep:blockchain",
            "nanocurrency", "currency", "stellar", "coin", "wallet", "bitstamp"]),
            &[("cryptography::cryptocurrencies", 0.8, 0.)]),
        (Cond::Any(&["ethereum", "rapid-blockchain-prototypes", "ethcore", "corelightning", "aptos", "fuel-vm", "xrpl", "tendermint", "randomx", "dep:wedpr_l_macros", "dep:solana-program", "tari", "safecoin",  "chainlink", "vapory", "arweave","nft", "web3", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
            "zcash", "bitcoin", "dep:tet-core", "tetcore", "kraken", "xynthe", "dep:anchor-lang", "dep:miniscript", "dep:ethereumvm", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
            "dep:holochain_core_types", "gemachain-sdkreumvm", "dep:hdk", "dep:cosmwasm-std", "dep:gemachain-sdk", "dep:ethers-core", "metaplex", "dep:spl-token", "dep:near-sdk","dep:gemachain-frozen-abi", "dep:safecoin-sdk", "dep:solana-sdk", "dep:ethabi", "dep:cxmr-currency",
            "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
            &[("cryptography::cryptocurrencies", 1.7, 0.8), ("science::math", 0.8, 0.), ("parsing", 0.6, 0.), ("network-programming", 0.6, 0.), ("data-structures", 0.6, 0.), ("cryptography", 0.5, 0.),
            ("database-implementations", 0.7, 0.), ("compilers", 0.5, 0.), ("database", 0.3, 0.), ("email", 0.6, 0.), ("value-formatting", 0.7, 0.), ("rust-patterns", 0.7, 0.), ("algorithms", 0.9, 0.),
            ...
            ("multimedia", 0.6, 0.),  ("development-tools::testing", 0.7, 0.), ("development-tools", 0.6, 0.), ("date-and-time", 0.4, 0.), ("wasm", 0.7, 0.)]),
        ...
        (Cond::Any(&["cryptocurrency", "dep:blockchain", "dep:ink_env", "dep:ink_primitives", "altcoin", "dep:web3", "dep:near-primitives", "dep:cw-utils", "dep:bitcoin", "dep:holochain_core_types", "dep:grin_api",
            ...
            &[("cryptography::cryptocurrencies", 1.7, 0.8), ("science::math", 0.7, 0.), ("multimedia", 0.8, 0.), ("data-structures", 0.7, 0.), ("cryptography", 0.4, 0.),
