...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "substrate", "eth", "xrp", "xrpl", "eth2", "dep:frame-support", "dep:gemachain-sdk", "dep:web3", "cryptocurrency", "vapory","arweave", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
            ...
            "parity", "solidity", "dep:holochain_core_types", "dep:solid","kraken", "holochain", "dep:miniscript", "metaplex", "web3", "bitcoin", "dep:spl-token", "ink", "solana", "monero", "xmr", "coinbase", "sovereign",
            "litecoin", "bitfinex", "ledger", "hyperledger", "btc", "interledger", "dep:anchor-lang", "agsol", "apdu", "dep:wedpr_l_macros", "consensus", "contract", "dep:parity-scale-codec", "self-sovereign", "dep:libp2p", "dep:bitcoin", "dep:blockchain",
            "nanocurrency", "currency", "stellar", "coin", "wallet", "bitstamp"]),
            &[("cryptography::cryptocurrencies", 0.8, 0.)]),
        (Cond::Any(&["ethereum", "rapid-blockchain-prototypes", "ethcore", "xrpl", "randomx", "dep:wedpr_l_macros", "dep:solana-program", "tari", "safecoin",  "chainlink", "vapory", "arweave","nft", "web3", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
