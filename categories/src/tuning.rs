...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["embedded", "dsp", "arm", "riscv", "svd2rust", "interrupt", "interrupts", "controller", "microcontroller", "microcontrollers", "analog", "lcd", "hw", "sdp", "bluez", "dep:btleplug", "hci", "xhci", "bluetooth", "ble", "cortex-m", "avr", "nickel", "device-drivers", "hal", "hardware-abstraction-layer", "driver", "register", "bare-metal",
        ...
        (Cond::Any(&["interpreter", "esolang", "jit", "zx", "gameboy", "super-nintendo", "emulator"]),
            &[("emulators", 1.25, 0.15), ("games", 0.7, 0.), ("parsing", 0.3, 0.), ("no-std", 0.7, 0.), ("email", 0.8, 0.), ("concurrency", 0.7, 0.), ("text-processing", 0.5, 0.), ("parser-implementations", 0.9, 0.),
        ...
        (Cond::Any(&["crypto", "nonce", "zero-knowledge", "entropy", "pem", "cert", "certificate", "certificates", "pki", "cryptohash"]),
            &[("cryptography", 1.2, 0.2), ("algorithms", 0.9, 0.), ("no-std", 0.8, 0.), ("development-tools::cargo-plugins", 0.9, 0.), ("filesystem", 0.8, 0.), ("command-line-utilities", 0.6, 0.)]),
        ...
        (Cond::Any(&["firmware", "raspberrypi", "broadcom", "rfcomm", "usb", "scsi", "hdd", "embedded-hal"]),
                ...
                ("compression", 0.7, 0.), ("multimedia::images", 0.6, 0.), ("os", 0.9, 0.), ("development-tools", 0.8, 0.),
        ...
        (Cond::Any(&["opengl", "directwrite", "gl", "skia", "d3d12", "sdl2", "gltf", "spirv", "shader", "directx"]),
