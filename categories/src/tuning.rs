...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "ethcore", "mimblewimble", "crypto", "contract", "contracts", "eth", "stake", "near", "dep:near-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:ethereum-types", "parity", "solidity", "dep:solid", "holochain", "bitcoin", "solana", "monero", "coinbase",
        ...
        (Cond::Any(&["ethereum", "ethcore", "bitcoin", "solidity", "holochain", "dep:solid", "mimblewimble", "dep:ethereumvm", "dep:near-sdk", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
        ...
        (Cond::Any(&["u128", "closure", "trait-object", "trait-objects", "unwrap", "fnonce", "cell", "object-safe", "byteorder", "printf", "nightly", "std",  "macro", "null", "standard-library"]),
        ...
        (Cond::All(&["sampling", "profiler"]), &[("development-tools::profiling", 1.2, 0.1), ("development-tools", 1.1, 0.)]),
        ...
        (Cond::Any(&["firmware", "raspberrypi", "broadcom", "rfcomm", "usb", "scsi", "hdd"]),
                &[("hardware-support", 1.2, 0.3), ("no-std", 0.9, 0.), ("command-line-utilities", 0.7, 0.), ("compression", 0.7, 0.), ("multimedia::images", 0.6, 0.), ("os", 0.9, 0.), ("development-tools", 0.8, 0.), ("development-tools::testing", 0.8, 0.), ("parsing", 0.6, 0.), ("development-tools::procedural-macro-helpers", 0.6, 0.), ("development-tools", 0.9, 0.)]),
        ...
        (Cond::Any(&["robotics", "roborio"]), &[("science::robotics", 1.15, 0.15)]),
        (Cond::Any(&["autonomous", "autonomos", "robots", "robot"]), &[("science::robotics", 1.1, 0.05)]),
        (Cond::Any(&["kinematics", "motor", "kalman"]), &[("science::robotics", 1.1, 0.05), ("simulation", 1.1, 0.05), ("science", 1.1, 0.)]),

        (Cond::Any(&["robotstxt", "robots-txt", "crawler", "web-bot", "sitemap", "scraper"]), &[("science::robotics", 0.3, 0.)]),
        (Cond::Any(&["spider", "url", "svg", "pgp", "gamepad", "interpreter", "ssl", "irc", "web"]), &[("science::robotics", 0.7, 0.)]),

        (Cond::Any(&["microcontrollers", "avr", "nickel", "crt0", "bare-metal", "micropython", "6502", "sgx", "embedded", "embedded-hal-driver"]),
            &[("embedded", 1.3, 0.25), ("no-std", 0.9, 0.), ("wasm", 0.7, 0.), ("multimedia::encoding", 0.8, 0.), ("multimedia::video", 0.8, 0.), ("development-tools", 0.8, 0.), ("web-programming", 0.7, 0.)]),
        ...
        (Cond::Any(&["gamepad", "joystick"]), &[("game-development", 1.2, 0.), ("games", 1.2, 0.)]),
        ...
        (Cond::Any(&["texture", "fps", "gamepad"]), &[("game-development", 1.2, 0.1)]),
        ...
        (Cond::NotAny(&["web", "http", "webrtc", "http2", "server", "router", "hyper", "actix", "apache", "conduit", "webserver", "serverless", "graphql", "aws", "lambda", "rpc", "iron",
            ...
            "rocket", "dep:actix-web", "dep:rocket", "actix", "elasticsearch"]),
