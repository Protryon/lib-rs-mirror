...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "ethcore", "mimblewimble", "crypto", "dep:ethereum-types", "parity", "bitcoin", "solana", "monero", "coinbase",
            "litecoin", "bitfinex", "ledger", "hyperledger", "self-sovereign", "nanocurrency", "currency", "stellar", "coin", "wallet", "bitstamp"]),
            &[("cryptography::cryptocurrencies", 0.7, 0.)]),
        (Cond::Any(&["ethereum", "ethcore", "bitcoin", "mimblewimble", "monero", "hyperledger"]),
