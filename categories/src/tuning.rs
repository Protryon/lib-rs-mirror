...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["compilator", "dsl", "type-checking", "programming-language", "gluon", "compiler", "cranelift"]), &[("development-tools", 1.1, 0.1), ("compilers", 1.2, 0.1)]),
        ...
        (Cond::Any(&["bioinformatics", "protein", "protein-sequences", "genomic", "fastq", "bio", "benzene", "chemical", "biological", "rna", "genotype", "genbank"]),
            ...
            ("parsing", 0.5, 0.), ("encoding", 0.9, 0.), ("embedded", 0.7, 0.), ("asynchronous", 0.7, 0.), ("command-line-utilities", 0.8, 0.)]),
        (Cond::Any(&["chemistry", "dep:bio", "sensory", "phylogenomics", "phenotype", "interactomics", "genomics", "molecules", "transcriptomics"]),
            &[("science", 1.2, 0.3), ("science::math", 0.6, 0.), ("visualization", 1.1, 0.), ("compilers", 0.7, 0.), ("no-std", 0.9, 0.), ("rust-patterns", 0.5, 0.),
        ...
        (Cond::NotAny(&["ethereum", "erc20", "substrate", "eth", "xrp", "xrpl", "corelightning", "aptos", "soroban", "fuel-vm", "sui", "algonaut", "eth2", "token", "dep:frame-support", "dep:gemachain-sdk", "dep:web3", "cryptocurrency", "vapory","arweave", "randomx", "dep:ic-cdk", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "marine", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
            ...
            "nanocurrency", "currency", "stellar", "coin", "wallet", "cardano", "pallas", "bitstamp"]),
        ...
        (Cond::Any(&["ethereum", "erc20", "rapid-blockchain-prototypes", "ethcore", "corelightning", "owasm", "aptos", "fuel-vm", "xrpl", "algonaut", "tendermint", "randomx", "dep:wedpr_l_macros", "dep:solana-program", "tari", "safecoin",  "chainlink", "vapory", "arweave","nft", "web3", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
            ...
            "dep:holochain_core_types", "gemachain-sdkreumvm", "dep:hdk", "pallas", "cardano", "dep:cosmwasm-std", "dep:gemachain-sdk", "dep:ethers-core", "dep:mv-core-types", "dep:move-deps", "metaplex", "dep:spl-token", "dep:near-sdk","dep:gemachain-frozen-abi", "dep:safecoin-sdk", "dep:solana-sdk", "dep:ethabi", "dep:cxmr-currency",
        ...
        (Cond::Any(&["websocket", "websockets"]), &[("web-programming::websocket", 1.85, 0.4), ("no-std", 0.9, 0.), ("wasm", 0.8, 0.), ("command-line-utilities", 0.5, 0.)]),
        ...
        (Cond::Any(&["gnuplot", "chart", "plot"]),
            &[("visualization", 1.3, 0.3), ("science::math", 0.75, 0.), ("wasm", 0.8, 0.), ("science", 0.8, 0.), ("command-line-interface", 0.5, 0.), ("command-line-utilities", 0.75, 0.), ("caching", 0.5, 0.)]),
        ...
        (Cond::Any(&["database", "databases", "datastore", "write-ahead-log"]), &[("database-implementations", 1.3, 0.3), ("no-std", 0.9, 0.), ("cryptography::cryptocurrencies", 0.9, 0.), ("multimedia", 0.8, 0.),("database", 1.3, 0.1), ("caching", 0.8, 0.), ("development-tools", 0.9, 0.)]),
        ...
        (Cond::All(&["aws", "rusoto"]), &[("network-programming", 1.2, 0.1), ("multimedia::video", 0.8, 0.), ("data-structures", 0.6, 0.), ("algorithms", 0.2, 0.), ("parsing", 0.5, 0.), ("filesystem", 0.6, 0.), ("web-programming", 1.2, 0.1)]),
        ...
        (Cond::Any(&["compress", "compression", "rar", "archive", "archives", "zip", "gzip"]),
            &[("compression", 1.3, 0.3), ("cryptography", 0.7, 0.), ("encoding", 0.7, 0.), ("games", 0.4, 0.), ("no-std", 0.7, 0.), ("asynchronous", 0.9, 0.),
        ...
        (Cond::All(&["error", "handling"]), &[("rust-patterns", 1.2, 0.), ("no-std", 0.8, 0.), ("data-structures", 0.9, 0.),]),
