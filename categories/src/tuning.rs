...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "erc20", "substrate", "eth", "xrp", "xrpl", "corelightning", "aptos", "soroban", "fuel-vm", "sui", "algonaut", "eth2", "token", "dep:frame-support", "dep:gemachain-sdk", "dep:web3", "cryptocurrency", "vapory","arweave", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
            ...
            "zk-snark", "dep:near-sdk", "dep:tet-core", "dep:solana-sdk", "dep:solana-program", "fungible", "iota", "dep:ethnum", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:safecoin-sdk", "dep:ethereum-types", "dep:ethereumvm",
            "parity", "solidity", "dep:holochain_core_types", "dep:solid","kraken", "holochain", "dep:miniscript", "metaplex", "web3", "tendermint", "bitcoin", "daml", "dep:spl-token", "ink", "solana", "monero", "xmr", "coinbase", "sovereign",
        ...
        (Cond::Any(&["ethereum", "erc20", "rapid-blockchain-prototypes", "ethcore", "corelightning", "aptos", "fuel-vm", "xrpl", "algonaut", "tendermint", "randomx", "dep:wedpr_l_macros", "dep:solana-program", "tari", "safecoin",  "chainlink", "vapory", "arweave","nft", "web3", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
            "zcash", "bitcoin", "dep:tet-core", "tetcore", "kraken", "solana", "xynthe", "dep:anchor-lang", "soroban", "dep:miniscript", "dep:ethereumvm", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
        ...
        (Cond::All(&["ledger", "public"]), &[("cryptography::cryptocurrencies", 1.2, 0.2), ("wasm", 0.7, 0.)]),
        ...
        (Cond::Any(&["gui", "desktop-applications"]), &[
            ("gui", 1.35, 0.1), ("command-line-interface", 0.15, 0.), ("algorithms", 0.8, 0.), ("wasm", 0.9, 0.), ("multimedia::video", 0.5, 0.)]),
