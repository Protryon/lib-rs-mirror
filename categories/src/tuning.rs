...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "cryptocurrency", "vapory", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
            "dep:ckb-types", "ethcore", "xynthe", "mimblewimble", "crypto", "contract", "contracts", "smart-contracts", "cosmos", "eth", "stake", "near",
            "zk-snark", "dep:near-sdk", "dep:tet-core", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:safecoin-sdk", "dep:ethereum-types",
            "parity", "solidity", "dep:holochain_core_types", "dep:solid", "holochain", "bitcoin", "solana", "monero", "coinbase",
            "litecoin", "bitfinex", "ledger", "hyperledger", "consensus", "contract", "dep:parity-scale-codec", "self-sovereign", "dep:libp2p", "dep:bitcoin", "dep:blockchain",
            "nanocurrency", "currency", "stellar", "coin", "wallet", "bitstamp"]),
            &[("cryptography::cryptocurrencies", 0.8, 0.)]),
        (Cond::Any(&["ethereum", "ethcore", "randomx", "tari", "vapory", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
            "zcash", "bitcoin", "dep:tet-core", "tetcore", "xynthe", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
            "dep:holochain_core_types", "dep:ethereumvm","dep:cosmwasm-std", "dep:near-sdk", "dep:safecoin-sdk", "dep:solana-sdk", "dep:ethabi", "dep:cxmr-currency",
        ...
        (Cond::Any(&["polkadot", "proof-of-work"]), &[("cryptography::cryptocurrencies", 1.2, 0.05)]),
