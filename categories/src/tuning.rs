...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["ethereum", "ethcore", "vapory", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos", "zcash", "bitcoin", "dep:tet-core", "tetcore", "xynthe", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
            "dep:holochain_core_types", "dep:ethereumvm","dep:cosmwasm-std", "dep:near-sdk", "dep:solana-sdk", "dep:ethabi", "dep:cxmr-currency", "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
