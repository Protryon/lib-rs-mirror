...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::NotAny(&["ethereum", "erc20", "substrate", "eth", "xrp", "xrpl", "corelightning", "aptos", "fuel-vm", "eth2", "token", "dep:frame-support", "dep:gemachain-sdk", "dep:web3", "cryptocurrency", "vapory","arweave", "randomx", "dfinity", "mining", "tari", "pow", "proof-of-work", "binance", "tetsy", "diem", "fluence", "snarkvm", "snarkos", "zcash", "tetcore",
        ...
        (Cond::Any(&["ethereum", "erc20", "rapid-blockchain-prototypes", "ethcore", "corelightning", "aptos", "fuel-vm", "xrpl", "tendermint", "randomx", "dep:wedpr_l_macros", "dep:solana-program", "tari", "safecoin",  "chainlink", "vapory", "arweave","nft", "web3", "dfinity", "snarkvm", "tetsy", "fluence", "dep:diem-types", "binance", "dep:ckb-types", "snarkos",
            "zcash", "bitcoin", "dep:tet-core", "tetcore", "kraken", "solana", "xynthe", "dep:anchor-lang", "dep:miniscript", "dep:ethereumvm", "solidity", "zk-snark", "smart-contracts", "holochain", "dep:solid", "mimblewimble",
        ...
        (Cond::NotAny(&["has:bin"]), &[("games", 0.5, 0.), ("development-tools::cargo-plugins", 0.7, 0.), ("command-line-utilities", 0.2, 0.)]),
