...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["kubernetes", "containerized", "k8s", "devops", "hypervisor"]),
            &[("development-tools", 1.2, 0.1), ("web-programming", 1.1, 0.02), ("web-programming::http-client", 0.9, 0.), ("no-std", 0.9, 0.), ("os::macos-apis", 0.9, 0.), ("config", 0.9, 0.), ("os::windows-apis", 0.1, 0.), ("command-line-utilities", 1.1, 0.02)]),
        ...
        (Cond::NotAny(&["wasm", "webasm", "asmjs", "webassembly", "wasi", "dep:wasi", "wasm-bindgen", "pwasm", "wasm32", "emscripten", "web-sys", "js", "frontend"]), &[("wasm", 0.6, 0.)]),
        ...
        (Cond::Any(&["dep:wasm-bindgen", "dep:wasi"]), &[("wasm", 1.2, 0.)]),

        (Cond::NotAny(&["embedded", "dsp", "arm", "riscv", "svd2rust", "interrupt", "controller", "microcontroller", "microcontrollers", "analog", "lcd", "hw", "sdp", "bluez", "hci", "bluetooth", "ble", "cortex-m", "avr", "nickel", "device-drivers", "hal", "hardware-abstraction-layer", "driver", "register", "bare-metal",
        ...
        (Cond::Any(&["bioinformatics", "benzene", "chemical", "biological", "rna", "genotype", "genbank"]),
            &[("science", 1.2, 0.3), ("science::math", 0.6, 0.), ("visualization", 1.1, 0.), ("no-std", 0.9, 0.), ("algorithms", 0.7, 0.), ("embedded", 0.7, 0.), ("asynchronous", 0.7, 0.), ("command-line-utilities", 0.8, 0.)]),
        ...
        (Cond::All(&["file", "format"]), &[("parser-implementations", 1.2, 0.1), ("encoding", 1.1, 0.), ("algorithms", 0.8, 0.), ("web-programming::http-server", 0.8, 0.)]),
        (Cond::All(&["file", "format", "parser"]), &[("parser-implementations", 1.2, 0.1), ("algorithms", 0.8, 0.), ("parsing", 0.9, 0.), ("development-tools::ffi", 0.8, 0.)]),
        ...
        (Cond::Any(&["dep:nom", "dep:lalrpop-util", "dep:lalrpop", "dep:pest_derive"]), &[("parser-implementations", 1.2, 0.1), ("parsing", 0.9, 0.)]),
        (Cond::Any(&["ll", "lr", "incremental"]),
            &[("parsing", 1.2, 0.), ("parser-implementations", 0.8, 0.)]),
        (Cond::Any(&["syntex", "decoder", "mime", "html", "dep:peg", "dep:pest"]),
            &[("parser-implementations", 1.2, 0.01), ("parsing", 0.8, 0.), ("caching", 0.8, 0.), ("no-std", 0.8, 0.)]),
        ...
        (Cond::Any(&["font", "dom", "files", "language", "formats", "lua", "format", "asn"]), &[("parsing", 0.5, 0.)]),
        ...
        (Cond::Any(&["fuzzy-logic", "natural-language-processing", "nlp"]),
            &[("science", 1.25, 0.2), ("science::ml", 1.3, 0.1), ("games", 0.5, 0.), ("os", 0.8, 0.), ("game-development", 0.75, 0.), ("algorithms", 1.2, 0.1), ("command-line-utilities", 0.8, 0.), ("command-line-interface", 0.4, 0.)]),
        ...
        (Cond::NotAny(&["ethereum", "ethcore", "mimblewimble", "crypto", "contract", "contracts", "eth", "stake", "near", "zk-snark", "dep:near-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "dep:ethereum-types", "parity", "solidity", "dep:solid", "holochain", "bitcoin", "solana", "monero", "coinbase",
        ...
        (Cond::Any(&["ethereum", "ethcore", "bitcoin", "solidity", "zk-snark", "holochain", "dep:solid", "mimblewimble", "dep:ethereumvm", "dep:near-sdk", "dep:solana-sdk", "dep:ethabi", "dep:sp-core", "dep:frame-support", "monero", "hyperledger"]),
            ...
            ("command-line-utilities", 0.8, 0.), ("multimedia::video", 0.5, 0.), ("multimedia", 0.6, 0.), ("multimedia::encoding", 0.5, 0.), ("development-tools::testing", 0.7, 0.), ("development-tools", 0.6, 0.), ("date-and-time", 0.4, 0.)]),
        ...
        (Cond::Any(&["cryptocurrency", "dep:blockchain", "altcoin", "dep:bitcoin", "dep:holochain_json_api", "dep:grin_api", "dep:grin_core", "bitcoincash", "cryptocurrencies", "blockchain", "blockchains", "exonum", "solana", "libra"]),
        ...
        (Cond::NotAny(&["tokio", "future", "futures", "promise", "promises", "executor", "reactor", "pin", "eventloop", "event-loop", "event", "callback",
            "callbacks", "non-blocking", "async", "async-await", "await", "asynchronous", "aio", "mio", "timer", "dep:mio", "dep:async-task"]),
            &[("asynchronous", 0.8, 0.)]),
        ...
        (Cond::Any(&["dep:tokio", "dep:actix", "dep:mio", "dep:async-std"]),
            &[("value-formatting", 0.7, 0.), ("parsing", 0.7, 0.), ("data-structures", 0.7, 0.), ("no-std", 0.7, 0.)]),
        ...
        (Cond::Any(&["unittests", "junit", "unit-testing", "pentest", "code-coverage", "testbed", "mocks"]),
            &[("development-tools::testing", 1.2, 0.2), ("development-tools::cargo-plugins", 0.9, 0.), ("rust-patterns", 0.9, 0.),
            ("development-tools", 0.8, 0.), ("os::macos-apis", 0.8, 0.), ("development-tools::build-utils", 0.8, 0.),
            ("games", 0.4, 0.), ("rendering::data-formats", 0.5, 0.), ("text-processing", 0.5, 0.)]),
        ...
        (Cond::Any(&["irc", "dht", "bot", "icmp"]), &[("network-programming", 1.2, 0.1), ("asynchronous", 0.8, 0.)]),
        ...
        (Cond::Any(&["dep:proc-macro2"]), &[("development-tools::procedural-macro-helpers", 1.2, 0.1)]),
        (Cond::Any(&["dep:quote"]), &[("development-tools::procedural-macro-helpers", 1.3, 0.15)]),
        ...
        (Cond::Any(&["dep:syn"]), &[("development-tools::procedural-macro-helpers", 1.2, 0.15)]),
        ...
        (Cond::Any(&["markdown", "commonmark", "common-mark", "unicode-aware", "latex", "mdbook", "dep:mdbook"]),
            &[("text-processing", 1.2, 0.2), ("parser-implementations", 1.2, 0.), ("multimedia::video", 0.8, 0.), ("parsing", 0.9, 0.), ("development-tools::testing", 0.2, 0.), ("filesystem", 0.7, 0.), ("development-tools", 0.8, 0.), ("multimedia::images", 0.5, 0.), ("command-line-interface", 0.9, 0.)]),
        ...
        (Cond::Any(&["rocket-league", "nintendo", "conway", "pokemon", "starcraft", "quake2", "quake3", "roguelike", "roguelikes", "minecraft", "sudoku"]),
        ...
        (Cond::NotAny(&["gamedev", "game", "games", "sdl", "ecs", "specs", "game-dev", "dep:allegro", "dice", "bounding", "library", "utils", "format", "polygon", "amethyst", "piston", "chess", "board", "ai"]),
            &[("game-development", 0.5, 0.)]),
        (Cond::NotAny(&["game", "games", "gamedev", "game-dev", "tetris", "conway", "level", "dice", "roguelike", "tic-tac-toe", "board-game", "save", "fantasy", "rpg", "rts", "play", "fun", "xbox", "gamepad", "voxel", "puzzle", "toy", "cards", "sudoku", "puzzle", "bounding", "chess", "amethyst", "piston"]),
        ...
        (Cond::All(&["voxel", "game"]), &[("games", 1.2, 0.2), ("game-development", 1.1, 0.)]),
        (Cond::Any(&["unreal-engine"]), &[("games", 1.2, 0.), ("game-development", 1.1, 0.)]),
        (Cond::All(&["unreal", "engine"]), &[("games", 1.2, 0.), ("game-development", 1.1, 0.)]),
        ...
        (Cond::Any(&["specs", "ecs", "http", "spider", "crawler"]), &[("command-line-utilities", 0.75, 0.), ("algorithms", 0.8, 0.), ("multimedia::video", 0.8, 0.)]),
        ...
        (Cond::Any(&["has:bin"]), &[("command-line-interface", 0.6, 0.), ("os::windows-apis", 0.7, 0.)]),
        ...
        (Cond::NotAny(&["web", "html", "js", "javascript", "json", "jwt", "github", "proxy", "apache", "pubsub", "rpc", "rest", "k8s", "containers", "kubernetes", "thrift", "serverless",
            ...
            "front-end", "ipfs", "youtube", "google", "webrtc", "jsonrpc", "streaming", "json-rpc", "dep:cookie", "jsonapi", "http-api", "rest-api", "json-api", "webhook", "dep:rocket", "dep:actix-web", "website", "ct-logs"]),
            &[("web-programming", 0.8, 0.)]),
        (Cond::NotAny(&["web", "http", "http2", "webrtc", "api", "fetch", "http-client", "serverless", "graphql", "lambda", "s3", "aws", "client", "rest", "thrift", "gotham", "hyper", "request", "json", "jsonrpc", "jsonapi", "rpc", "curl", "tls", "requests", "http-api", "json-api"]),
        ...
        (Cond::NotAny(&["web", "http", "webrtc", "http2", "server", "router", "hyper", "actix", "actix-web", "apache", "conduit", "webserver", "serverless", "graphql", "aws", "lambda", "rpc", "iron",
            ...
            "rocket", "dep:actix-web", "dep:rocket", "actix", "lucene", "elasticsearch"]),
        ...
        (Cond::All(&["graphics", "gpu"]), &[("rendering::graphics-api", 1.34, 0.1), ("parsing", 0.5, 0.)]),
        ...
        (Cond::Any(&["gfx-rs"]), &[("game-development", 0.9, 0.), ("algorithms", 0.8, 0.)]),
        (Cond::All(&["graphics", "sdk", "polygon", "polygons"]), &[("rendering::graphics-api", 1.2, 0.1)]),
