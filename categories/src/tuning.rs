...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["autotools", "ld_preload", "libnotify", "syslog", "systemd", "seccomp", "kill", "ebpf"]),
            ...
            ("gui", 0.9, 0.), ("game-development", 0.6, 0.), ("multimedia::images", 0.2, 0.),
        ...
        (Cond::Any(&["physics", "ncollide", "pressure"]),
            &[("science", 1.2, 0.1), ("simulation", 1.2, 0.1), ("multimedia::video", 0.8, 0.), ("game-development", 1.1, 0.), ("science::math", 0.8, 0.), ("parsing", 0.8, 0.), ("parser-implementations", 0.8, 0.), ("science::ml", 0.7, 0.), ]),
        (Cond::Any(&["collision"]),
