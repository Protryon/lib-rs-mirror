...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["fun", "quake", "play", "steam", "asteroids"]), &[("games", 1.2, 0.1)]),
        ...
        (Cond::NotAny(&["gamedev", "game", "games", "sdl", "ecs", "specs", "game-dev", "dep:allegro", "bounding", "library", "utils", "format", "polygon", "amethyst", "piston", "chess", "board", "ai"]),
            &[("game-engines", 0.5, 0.)]),
        (Cond::NotAny(&["game", "games", "gamedev", "game-dev", "tetris", "conway", "roguelike", "save", "play", "fun", "voxel", "puzzle", "toy", "cards", "sudoku", "puzzle", "bounding", "chess", "amethyst", "piston"]),
