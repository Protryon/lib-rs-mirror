...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["multimedia", "chromecast", "media", "dvd"]), &[("multimedia", 1.3, 0.3), ("algorithms", 0.8, 0.), ("encoding", 0.5, 0.)]),
        ...
        (Cond::All(&["api", "client"]), &[("network-programming", 1.1, 0.05), ("web-programming", 1.1, 0.05), ("algorithms", 0.8, 0.), ("config", 0.8, 0.), ("development-tools::cargo-plugins", 0.7, 0.)]),
        ...
        (Cond::Any(&["command-line-tool"]), &[("command-line-utilities", 1.2, 0.4), ("algorithms", 0.8, 0.), ("no-std", 0.7, 0.)]),
        ...
        (Cond::Any(&["pop3", "ssmtp", "smtp", "imap", "email"]), &[("email", 1.2, 0.3), ("parsing", 0.9, 0.), ("no-std", 0.7, 0.), ("algorithms", 0.8, 0.),
            ("development-tools::cargo-plugins", 0.6, 0.), ("filesystem", 0.7, 0.), ("command-line-utilities", 0.75, 0.)]),
        ...
        (Cond::Any(&["cli", "utility", "utilities",  "tool", "command", "ripgrep", "tools"]),
            ...
            ("rendering::engine", 0.6, 0.), ("science", 0.9, 0.), ("simulation", 0.75, 0.), ("data-structures", 0.75, 0.)]),
        (Cond::All(&["cli", "utility"]),
            &[("command-line-utilities", 1.3, 0.3), ("command-line-interface", 0.3, 0.), ("data-structures", 0.6, 0.), ("algorithms", 0.8, 0.), ("games", 0.1, 0.), ("filesystem", 0.6, 0.), ("science", 0.8, 0.)]),
        (Cond::All(&["cli", "tool"]),
            &[("command-line-utilities", 1.3, 0.3), ("command-line-interface", 0.3, 0.), ("data-structures", 0.6, 0.), ("filesystem", 0.8, 0.), ("science", 0.8, 0.)]),


        (Cond::NotAny(&["web", "html", "js", "javascript", "json", "jwt", "proxy", "rest", "serverless", "lambda", "aws", "mime", "wordpress", "rss", "atom", "xml", "css", "xss", "rocket", "webhook", "hyper", "nodejs", "asmjs", "browser", "front-end", "ipfs", "youtube", "google", "jsonrpc"]),
        ...
        (Cond::All(&["cloud", "web"]), &[("web-programming", 1.4, 0.2), ("data-structures", 0.6, 0.), ("algorithms", 0.8, 0.), ("parsing", 0.8, 0.), ("config", 0.8, 0.), ("filesystem", 0.7, 0.), ("no-std", 0.7, 0.), ("development-tools::build-utils", 0.8, 0.)]),
        ...
        (Cond::Any(&["iron", "kafka", "actix-web", "wsgi", "openid", "graphql", "restful", "http-server"]),
            &[("web-programming::http-server", 1.2, 0.11), ("web-programming", 1.1, 0.), ("algorithms", 0.8, 0.), ("no-std", 0.5, 0.), ("command-line-interface", 0.3, 0.),
            ("data-structures", 0.7, 0.),("command-line-utilities", 0.75, 0.), ("development-tools::cargo-plugins", 0.4, 0.)]),
        ...
        (Cond::Any(&["http", "dns", "dnssec", "grpc", "rpc", "json-rpc", "jwt", "statsd", "telemetry"]),
            &[("network-programming", 1.2, 0.), ("web-programming::websocket", 0.88, 0.), ("parsing", 0.9, 0.), ("config", 0.9, 0.),
            ("value-formatting", 0.8, 0.), ("data-structures", 0.7, 0.), ("command-line-utilities", 0.9, 0.), ("development-tools::testing", 0.9, 0.)]),
