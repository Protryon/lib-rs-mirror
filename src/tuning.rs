...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["has:is_sys"]), &[("development-tools::ffi", 0.1, 0.), ("no-std", 0.7, 0.), ("development-tools::debugging", 0.8, 0.),
            ("development-tools::websocket", 0.6, 0.), ("development-tools::build-utils", 0.6, 0.), ("games", 0.2, 0.), ("filesystem", 0.9, 0.), ("multimedia", 0.8, 0.), ("cryptography", 0.8, 0.), ("command-line-utilities", 0.2, 0.)]),
        ...
        (Cond::All(&["aws", "rusoto", "nextcloud"]), &[("network-programming", 1.2, 0.1), ("multimedia::video", 0.8, 0.), ("algorithms", 0.2, 0.), ("parsing", 0.5, 0.), ("filesystem", 0.6, 0.), ("web-programming", 1.2, 0.1)]),
        ...
        (Cond::Any(&["pop3", "ssmtp", "smtp", "imap", "email"]), &[("email", 1.2, 0.3), ("parsing", 0.9, 0.), ("no-std", 0.7, 0.), ("development-tools::cargo-plugins", 0.6, 0.), ("filesystem", 0.7, 0.), ("command-line-utilities", 0.75, 0.)]),
        ...
        (Cond::NotAny(&["file", "path", "file-system", "io", "fs", "directory", "directories", "dir", "folder", "basedir", "xdg", "nfs", "samba", "disk", "xattr",
        ...
        (Cond::All(&["protocol", "web"]), &[("web-programming", 1.4, 0.1), ("parsing", 0.8, 0.), ("filesystem", 0.7, 0.), ("command-line-utilities", 0.75, 0.)]),
        (Cond::All(&["web", "api"]), &[("web-programming", 1.3, 0.1), ("data-structures", 0.6, 0.)]),
        (Cond::All(&["cloud", "web"]), &[("web-programming", 1.4, 0.2), ("data-structures", 0.6, 0.), ("parsing", 0.8, 0.), ("filesystem", 0.7, 0.), ("no-std", 0.7, 0.), ("development-tools::build-utils", 0.8, 0.)]),
        ...
        (Cond::Any(&["blender", "graphics", "image-processing"]), &[("multimedia::images", 1.2, 0.), ("rendering::graphics-api", 1.05, 0.), ("filesystem", 0.7, 0.), ("games", 0.8, 0.), ("simulation", 0.5, 0.)]),

        (Cond::Any(&["gpgpu", "cudnn"]), &[("asynchronous", 0.2, 0.), ("game-engines", 0.8, 0.), ("filesystem", 0.7, 0.), ("development-tools::testing", 0.8, 0.),
