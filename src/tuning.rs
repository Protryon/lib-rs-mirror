...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["hmac-sha256", "sha1", "sha2", "shamir", "cipher", "aes", "rot13", "md5", "pkcs7", "keccak", "scrypt", "bcrypt", "merkle", "digest", "chacha20"]),
            &[("cryptography", 1.4, 0.3), ("algorithms", 0.9, 0.), ("no-std", 0.95, 0.), ("rendering::engine", 0.7, 0.),
            ("command-line-utilities", 0.75, 0.), ("development-tools::testing", 0.8, 0.)]),
        ...
        (Cond::Any(&["opengl", "gl", "skia", "vulkan", "vk", "spirv", "shader", "directx"]),
                &[("rendering::graphics-api", 1.3, 0.15), ("science::math", 0.8, 0.), ("rendering", 1.1, 0.1), ("rendering::data-formats", 0.9, 0.),
