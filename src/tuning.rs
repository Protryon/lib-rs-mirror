...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["mount", "platforms", "platform", "package", "uname", "executable", "processes", "processor", "child",  "system", "boot", "kernel", "keycode"]),
        ...
        (Cond::Any(&["dependency-manager", "package-manager", "clipboard", "process", "bootloader", "taskbar", "microkernel", "multiboot"]),
            &[("os", 1.2, 0.1), ("network-programming", 0.8, 0.), ("cryptography", 0.7, 0.), ("filesystem", 0.8, 0.), ("games", 0.2, 0.), ("authentication", 0.6, 0.),
        ...
        (Cond::All(&["linux", "kernel"]), &[("os::unix-apis", 1.3, 0.2)]),
        ...
        (Cond::Any(&["signal","epoll", "sigint", "syscall", "ioctl", "affinity", "ld_preload", "libnotify", "syslog", "systemd", "seccomp"]),
            &[("os::unix-apis", 1.2, 0.1), ("date-and-time", 0.1, 0.), ("memory-management", 0.6, 0.), ("games", 0.2, 0.),
        ...
        (Cond::Any(&["parser"]),
            ...
            ("development-tools::debugging", 0.8, 0.), ("rendering::graphics-api", 0.3, 0.), ("web-programming::http-client", 0.75, 0.),
            ("command-line-utilities", 0.75, 0.), ("command-line-interface", 0.5, 0.), ("games", 0.7, 0.)]),
        (Cond::All(&["format", "parser"]), &[("parser-implementations", 1.3, 0.2), ("parsing", 0.95, 0.), ("games", 0.8, 0.)]),
        (Cond::All(&["file", "format", "parser"]), &[("parser-implementations", 1.3, 0.1), ("parsing", 0.9, 0.)]),
        ...
        (Cond::Any(&["string", "binary", "streaming", "version", "buffer", "escape", "opengl", "memchr", "android", "ios", "recursive", "cuda"]),
        ...
        (Cond::Any(&["boolean"]), &[("development-tools::testing", 0.9, 0.), ("multimedia::images", 0.8, 0.), ("multimedia::audio", 0.8, 0.),
        ...
        (Cond::All(&["kernel", "image"]), &[("multimedia::images", 0.1, 0.)]),
        (Cond::All(&["binary", "image"]), &[("multimedia::images", 0.8, 0.)]),
        (Cond::All(&["bootable", "image"]), &[("multimedia::images", 0.1, 0.)]),
        (Cond::Any(&["imagemagick", "gamma", "photo", "exif", "openexr", "flif", "png", "jpeg2000", "jpeg", "svg", "pixel"]), &[("multimedia::images", 1.2, 0.1), ("encoding", 0.5, 0.), ("parsing", 0.6, 0.)]),
        ...
        (Cond::Any(&["interpreter", "jit", "zx", "emulator"]),
            &[("emulators", 1.25, 0.1), ("games", 0.7, 0.), ("text-processing", 0.5, 0.), ("multimedia::images", 0.5, 0.), ("no-std", 0.8, 0.), ("command-line-interface", 0.5, 0.), ("multimedia::video", 0.5, 0.), ("command-line-utilities", 0.75, 0.)]),
        (Cond::Any(&["qemu", "vm", "codegen"]), &[("emulators", 1.4, 0.1), ("development-tools", 1.1, 0.), ("multimedia::video", 0.5, 0.), ("wasm", 0.8, 0.)]),
        ...
        (Cond::Any(&["database", "databases", "datastore"]), &[("database-implementations", 1.3, 0.3), ("cryptography::cryptocurrencies", 0.9, 0.), ("database", 1.3, 0.1), ("caching", 0.88, 0.), ("development-tools", 0.9, 0.)]),
        (Cond::All(&["personal", "information", "management"]), &[("database-implementations", 1.5, 0.3)]),
        (Cond::All(&["rpm", "redis"]), &[("database-implementations", 1.25, 0.1), ("os", 0.5, 0.), ("os::unix-apis", 0.7, 0.)]),
        (Cond::Any(&["nosql", "geoip", "key-value"]), &[("database", 1.5, 0.3), ("database-implementations", 1.2, 0.1), ("data-structures", 1.2, 0.1), ("command-line-utilities", 0.5, 0.)]),
        ...
        (Cond::Any(&["database", "db", "sqlite3", "sqlite", "leveldb", "postgres", "postgresql", "orm", "mysql","hadoop", "sqlite", "mongo","elasticsearch", "cassandra", "rocksdb", "redis", "couchdb", "diesel"]),
                &[("database", 1.4, 0.2), ("text-processing", 0.7, 0.), ("rust-patterns", 0.7, 0.), ("database-implementations", 1.1, 0.1), ("value-formatting", 0.7, 0.), ("hardware-support", 0.6, 0.),
        ...
        (Cond::All(&["key", "value", "store"]), &[("database", 1.2, 0.2), ("database-implementations", 1.2, 0.2)]),
        ...
        (Cond::All(&["cloud", "google"]), &[("network-programming", 1.2, 0.1), ("web-programming", 1.2, 0.2), ("development-tools::build-utils", 0.6, 0.)]),
        (Cond::All(&["api", "client"]), &[("network-programming", 1.1, 0.05), ("web-programming", 1.1, 0.05)]),
        ...
        (Cond::Any(&["references", "methods", "own", "function", "variables", "inference", "assert"]),
                &[("rust-patterns", 1.2, 0.1), ("command-line-utilities", 0.7, 0.), ("command-line-interface", 0.8, 0.), ("no-std", 0.95, 0.), ("asynchronous", 0.8, 0.),
                ("development-tools::testing", 0.9, 0.), ("internationalization", 0.7, 0.), ("template-engine", 0.8, 0.)]),
        (Cond::Any(&["endianness", "derive", "float", "floats", "floating-point", "initialized", "primitives", "tuple", "type-level", "panic", "literal"]),
        ...
        (Cond::Any(&["dsp", "movies"]), &[("games", 0.5, 0.), ("data-structures", 0.9, 0.)]),
        ...
        (Cond::Any(&["safe", "unsafe"]), &[("multimedia::video", 0.8, 0.), ("development-tools::cargo-plugins", 0.5, 0.), ("rendering::engine", 0.8, 0.)]),
        ...
        (Cond::Any(&["pdf", "epub", "ebook", "book", "typesetting", "xetex"]),
            &[("text-processing", 1.3, 0.2), ("science", 0.9, 0.), ("science::math", 0.8, 0.), ("games", 0.8, 0.), ("rendering::data-formats", 1.2, 0.), ("rendering", 1.05, 0.), ("web-programming::http-client", 0.5, 0.), ("command-line-interface", 0.5, 0.)]),
        ...
        (Cond::Any(&["templating", "template", "template-engine", "handlebars"]),
            &[("template-engine", 1.4, 0.3), ("embedded", 0.2, 0.), ("games", 0.5, 0.), ("command-line-interface", 0.4, 0.)]),
        ...
        (Cond::Any(&["terminal", "ncurses", "ansi", "progressbar", "vt100", "term", "console", "readline", "repl", "getopts"]),
            &[("command-line-interface", 1.2, 0.1), ("multimedia::images", 0.1, 0.), ("multimedia", 0.4, 0.), ("wasm", 0.9, 0.),
        ...
        (Cond::Any(&["memory", "garbage", "rc"]), &[("memory-management", 1.25, 0.1), ("os", 1.1, 0.), ("development-tools::cargo-plugins", 0.8, 0.),
        ...
        (Cond::All(&["cloud", "web"]), &[("web-programming", 1.4, 0.2), ("data-structures", 0.6, 0.), ("development-tools::build-utils", 0.8, 0.)]),
        ...
        (Cond::Any(&["runtime"]), &[("development-tools", 1.3, 0.1), ("no-std", 0.8, 0.)]),
        ...
        (Cond::Any(&["http", "dns", "dnssec", "grpc", "rpc", "json-rpc", "jwt"]),
        ...
        (Cond::Any(&["direct2d", "glsl", "vulkan", "glium", "cairo", "freetype"]),
                ...
                ("hardware-support", 0.8, 0.), ("development-tools::testing", 0.6, 0.), ("memory-management", 0.8, 0.)]),
        ...
        (Cond::Any(&["render", "bresenham", "oculus", "opengl-based", "gfx", "vr", "shader", "sprites", "nvidia", "ray", "renderer", "raytracing", "ray-tracing", "ray-casting"]),
                ...
                ("rendering::graphics-api", 1.1, 0.1), ("games", 0.8, 0.), ("hardware-support", 0.8, 0.), ("development-tools::testing", 0.6, 0.), ("development-tools::build-utils", 0.6, 0.)]),
        ...
        (Cond::Any(&["gpgpu", "cudnn"]), &[("asynchronous", 0.2, 0.), ("development-tools::testing", 0.8, 0.), ("development-tools::build-utils", 0.6, 0.)]),
