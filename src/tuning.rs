...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["ios", "objective-c"]), &[("os::macos-apis", 1.1, 0.1), ("no-std", 0.1, 0.)]),
        (Cond::Any(&["linux", "freebsd", "netbsd", "arch-linux", "pacman", "deb", "rpm"]),
        ...
        (Cond::Any(&["signal","epoll", "sigint", "syscall", "ioctl", "affinity", "ld_preload", "libnotify", "syslog", "systemd", "seccomp"]),
            &[("os::unix-apis", 1.2, 0.1), ("date-and-time", 0.1, 0.), ("games", 0.2, 0.), ("gui", 0.9, 0.), ("game-engines", 0.6, 0.), ("multimedia::images", 0.2, 0.),
        ...
        (Cond::Any(&["bindings", "binding", "ffi-bindings", "wrapper", "api-wrapper"]),
            &[("development-tools::ffi", 0.8, 0.), ("games", 0.2, 0.), ("command-line-utilities", 0.2, 0.), ("no-std", 0.9, 0.), ("rendering::data-formats", 0.2, 0.)]),
        ...
        (Cond::Any(&["parser"]),
            ...
            ("development-tools::debugging", 0.8, 0.), ("rendering::graphics-api", 0.3, 0.), ("web-programming::http-client", 0.75, 0.), ("command-line-utilities", 0.75, 0.), ("command-line-interface", 0.5, 0.)]),
        (Cond::All(&["format", "parser"]), &[("parser-implementations", 1.3, 0.2), ("parsing", 0.95, 0.)]),
        ...
        (Cond::Any(&["tokenizer", "sanitizer", "parse", "lexer", "parser", "parsing"]),
            &[("science::math", 0.6, 0.), ("data-structures", 0.7, 0.), ("games", 0.5, 0.), ("os::macos-apis", 0.9, 0.), ("command-line-utilities", 0.8, 0.),
        ...
        (Cond::Any(&["math", "maths", "calculus", "geometry", "logic", "satisfiability", "combinatorics", "fft"]),
            &[("science::math", 1.25, 0.3), ("science", 0.8, 0.), ("web-programming::http-client", 0.9, 0.), ("rendering::graphics-api", 0.8, 0.), ("algorithms", 1.2, 0.1), ("games", 0.5, 0.), ("os", 0.8, 0.),("game-engines", 0.75, 0.), ("command-line-utilities", 0.8, 0.), ("command-line-interface", 0.4, 0.)]),
        (Cond::Any(&["polynomial", "gaussian", "mathematics", "bignum", "prime", "primes", "linear-algebra", "algebra", "euler", "bijective"]),
            &[("science::math", 1.25, 0.3), ("science", 0.8, 0.), ("web-programming::http-client", 0.9, 0.), ("rendering::graphics-api", 0.8, 0.), ("algorithms", 1.2, 0.1), ("games", 0.5, 0.), ("os", 0.8, 0.),("game-engines", 0.75, 0.), ("command-line-utilities", 0.8, 0.), ("command-line-interface", 0.4, 0.)]),
        ...
        (Cond::Any(&["ethereum", "ethcore", "bitcoin", "monero", "coinbase", "litecoin", "bitfinex", "nanocurrency"]),
            &[("cryptography::cryptocurrencies", 1.5, 0.44), ("science::math", 0.8, 0.), ("cryptography", 0.8, 0.), ("database-implementations", 0.7, 0.), ("database", 0.7, 0.), ("value-formatting", 0.7, 0.), ("algorithms", 0.9, 0.), ("embedded", 0.8, 0.), ("no-std", 0.4, 0.), ("command-line-utilities", 0.8, 0.), ("development-tools::testing", 0.7, 0.), ("development-tools", 0.6, 0.), ("date-and-time", 0.4, 0.)]),
        ...
        (Cond::Any(&["codegen", "references", "methods", "own", "function", "variables", "inference", "assert"]),
                &[("rust-patterns", 1.2, 0.1), ("command-line-utilities", 0.7, 0.), ("command-line-interface", 0.8, 0.), ("no-std", 0.95, 0.), ("asynchronous", 0.8, 0.),
                ("development-tools::testing", 0.9, 0.), ("internationalization", 0.7, 0.), ("template-engine", 0.8, 0.)]),
        (Cond::Any(&["endianness", "derive", "float", "floats", "floating-point", "initialized", "primitives", "tuple", "type-level", "panic", "literal", "trait", "cow", "range", "annotation", "generics", "traits", "oop", "type", "types", "scope", "functions", "clone"]),
        ...
        (Cond::Any(&["structures", "data-structure", "trie", "incremental", "tree", "trees", "intersection"]),
            &[("data-structures", 1.2, 0.1), ("algorithms", 1.1, 0.), ("science", 0.8, 0.), ("multimedia::audio", 0.9, 0.), ("command-line-utilities", 0.9, 0.), ("text-editors", 0.7, 0.), ("internationalization", 0.7, 0.)]),
        ...
        (Cond::Any(&["computational", "hpc", "tries", "collection", "pathfinding", "rational", "newtonian", "scientific", "science"]),
            &[("science", 1.25, 0.2), ("algorithms", 1.2, 0.1), ("data-structures", 1.2, 0.1), ("command-line-interface", 0.3, 0.), ("simulation", 0.75, 0.),("command-line-utilities", 0.75, 0.), ("games", 0.3, 0.), ("no-std", 0.95, 0.), ("caching", 0.8, 0.), ("development-tools::profiling", 0.6, 0.), ("internationalization", 0.7, 0.)]),
        (Cond::Any(&["median", "alpha", "equations", "bigdecimal", "matrix", "proving", "matrices", "sat", "multi-dimensional", "unification"]),
        ...
        (Cond::Any(&["unicode",  "characters", "grapheme", "crlf", "codepage", "whitespace", "utf-8", "utf8", "case"]),
            &[("text-processing", 1.1, 0.2), ("rendering", 0.9, 0.), ("embedded", 0.8, 0.), ("web-programming", 0.9, 0.), ("rendering::data-formats", 0.5, 0.), ("development-tools::testing", 0.6, 0.)]),
        ...
        (Cond::All(&["games", "framework"]), &[("game-engines", 1.3, 0.2), ("games", 0.6, 0.)]),
        ...
        (Cond::Any(&["temp-file", "backups", "backup",  "xattr", "ionotify", "inode", "directories", "dir", "filesystem", "fuse"]),
             ...
             ("os", 0.95, 0.), ("gui", 0.9, 0.), ("science", 0.8, 0.), ("science::math", 0.3, 0.), ("development-tools", 0.95, 0.), ("cryptography", 0.6, 0.),
             ("asynchronous", 0.8, 0.), ("algorithms", 0.8, 0.), ("development-tools::testing", 0.9, 0.), ("command-line-utilities", 0.75, 0.)]),
        (Cond::Any(&["file"]), &[("filesystem", 1.1, 0.), ("no-std", 0.8, 0.)]),
        ...
        (Cond::Any(&["render", "bresenham", "oculus", "opengl-based", "gfx", "vr", "shader", "sprites", "nvidia", "ray", "renderer", "raytracing"]),
                &[("rendering", 1.15, 0.1), ("rendering::engine", 1.1, 0.05), ("rendering::data-formats", 0.9, 0.), ("web-programming::websocket", 0.15, 0.),
        ...
        (Cond::Any(&["font", "ttf", "truetype", "svg", "tesselation", "exporter", "mesh"]),
            &[("rendering::data-formats", 1.2, 0.1), ("gui", 0.7, 0.), ("parsing", 0.6, 0.), ("games", 0.5, 0.), ("web-programming::websocket", 0.25, 0.)]),
