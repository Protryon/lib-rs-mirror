...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["docker", "kubernetes", "k8s", "devops"]),
            &[("development-tools", 1.2, 0.1), ("web-programming", 1.1, 0.02), ("os::macos-apis", 0.9, 0.), ("os::windows-apis", 0.1, 0.), ("command-line-utilities", 1.1, 0.02)]),
        ...
        (Cond::Any(&["wasm", "webasm", "webassembly"]),
            ...
            ("os::macos-apis", 0.5, 0.), ("os::unix-apis", 0.5, 0.), ("os::windows-apis", 0.5, 0.),
        ...
        (Cond::Any(&["cryptocurrency", "altcoin", "cryptocurrencies", "blockchain", "exonum"]),
            ...
            ("database", 0.3, 0.), ("email", 0.6, 0.), ("value-formatting", 0.7, 0.), ("algorithms", 0.9, 0.), ("embedded", 0.6, 0.), ("no-std", 0.4, 0.), ("development-tools::cargo-plugins", 0.7, 0.),
            ("command-line-utilities", 0.8, 0.), ("development-tools::testing", 0.7, 0.), ("development-tools", 0.6, 0.), ("date-and-time", 0.4, 0.)]),
        ...
        (Cond::All(&["aws", "rusoto", "nextcloud"]), &[("network-programming", 1.2, 0.1), ("multimedia::video", 0.8, 0.), ("algorithms", 0.2, 0.), ("parsing", 0.5, 0.), ("web-programming", 1.2, 0.1)]),
        (Cond::All(&["aws", "sdk"]), &[("network-programming", 1.2, 0.2), ("web-programming", 1.2, 0.1), ("filesystem", 0.5, 0.)]),
        ...
        (Cond::NotAny(&["has:proc_macro", "derive", "proc-macro", "proc-macros", "procmacro", "syntax"]), &[("development-tools::procedural-macro-helpers", 0.6, 0.)]),
        ...
        (Cond::NotAny(&["crypto", "cryptography", "cryptographic", "hash", "hashing", "digest", "nacl", "blake2", "libsodium", "zeroize", "hmac",
            "constant-time", "constant_time", "ecc", "rsa", "ecdsa","ed25519","argon2", "pbkdf2","block-cipher","cipher","signature",
        ...
        (Cond::NotAny(&["has:bin"]), &[("games", 0.8, 0.), ("command-line-utilities", 0.8, 0.)]),
        (Cond::Any(&["has:cargo-bin"]), &[("development-tools::cargo-plugins", 1.2, 0.1), ("development-tools::procedural-macro-helpers", 0.8, 0.), ("memory-management", 0.6, 0.)]),
        ...
        (Cond::Any(&["microcontrollers", "avr", "nickel", "crt0", "bare-metal", "micropython", "6502", "sgx", "embedded"]),
        ...
        (Cond::NotAny(&["web", "html", "js", "javascript", "json", "proxy", "rest", "serverless", "lambda", "aws", "wordpress", "rss", "atom", "xml", "css", "xss", "rocket", "webhook", "hyper", "nodejs", "asmjs", "browser", "front-end", "ipfs", "youtube", "google", "jsonrpc"]),
            &[("web-programming", 0.8, 0.)]),
        (Cond::NotAny(&["web", "http", "http2", "api", "fetch", "http-client", "serverless", "lambda", "s3", "aws", "client", "rest", "gotham", "hyper", "request", "json", "jsonrpc", "rpc", "curl", "tls", "requests"]),
            &[("web-programming::http-client", 0.8, 0.)]),
        (Cond::NotAny(&["web", "http", "http2", "server", "router", "hyper", "actix", "webserver", "serverless", "aws", "lambda", "rpc", "iron", "tcp", "sse", "server-sent-events", "service", "middleware", "microservice", "proxy", "rest", "restful", "framework", "rocket", "actix"]),
            &[("web-programming::http-server", 0.8, 0.)]),
        (Cond::Any(&["hyper"]), &[("web-programming::http-client", 1.2, 0.), ("web-programming::http-server", 1.1, 0.)]),
