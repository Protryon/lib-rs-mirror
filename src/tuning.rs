...
lazy_static! {
    ...
    pub(crate) static ref KEYWORD_CATEGORIES: Vec<(Cond, &'static [(&'static str, f64, f64)])> = [
        ...
        (Cond::Any(&["mount", "platforms", "platform", "package", "uname", "executable", "processes", "processor", "child",  "system", "boot", "kernel", "keycode"]),
            ...
            ("games", 0.7, 0.), ("authentication", 0.6, 0.), ("localization", 0.7, 0.)]),
        ...
        (Cond::Any(&["plural", "pluralize", "iso3166-1", "iso3166", "bcp47"]), &[("internationalization", 1.2, 0.1), ("localization", 1.2, 0.1)]),
